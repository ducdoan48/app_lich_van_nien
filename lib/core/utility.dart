...
// ignore_for_file: prefer_typing_uninitialized_variables, non_constant_identifier_names, duplicate_ignore, unused_local_variable

import 'dart:math';

// date_utils
String getNameDayofWeek(DateTime date) { //weekday: thứ 
